...
#define s21_size_t \
  unsigned long  // или через  typedef unsigned int size_t; ?  будем
                 // привязываться к размеру адреса?
#define S21_NULL ((void *)0)
// <either 0, 0L, or (void *)0> [0 in C++]  нашел это, но не знаю как правильно,
// (void *)0  - ok
